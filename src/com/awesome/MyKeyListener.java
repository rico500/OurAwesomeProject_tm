...
class MyKeyListener implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (!pressedKeys.contains(e.getKeyChar())){
            ...
            new Thread(() -> {
                LogiLED.LogiLedSaveLightingForKey(keyCodes[keyPressedIndex]);
                LogiLED.LogiLedSetLightingForKeyWithKeyName(keyCodes[keyPressedIndex], 100, 0, 0);
                try{
                    Thread.sleep(750);
                ...
                LogiLED.LogiLedRestoreLightingForKey(keyCodes[keyPressedIndex]);
            }).start();
        }
    }
